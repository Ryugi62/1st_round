((window) => {
  ...
  const lignePaginate = () => {
    ...
    const createPagination = () => {
      ...
      paginationContainer.className = "paginate"; // CSS 클래스 추가
      ...
      prevButton.className = "paginate_control_prev"; // CSS 클래스 추가
      ...
      for (let i = 1; i <= pageCount; i++) {
        ...
        pageButton.className = "paginate_button"; // CSS 클래스 추가
      ...
      nextButton.className = "paginate_control_next"; // CSS 클래스 추가
